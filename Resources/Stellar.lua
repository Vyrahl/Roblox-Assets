...
local Typeface = loadstring(game:HttpGet("https://raw.githubusercontent.com/Vyrahl/Roblox-Assets/refs/heads/main/Resources/TrueType.lua"))()
Library.Theme.Font = Typeface:Register("fonts", {
	name = "font",
	link = "https://raw.githubusercontent.com/Vyrahl/Roblox-Assets/refs/heads/main/Fonts/tahoma.ttf",
	weight = "Regular",
	style = "Normal"
})
